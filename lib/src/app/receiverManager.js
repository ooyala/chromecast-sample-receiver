 ...
 * @param {cast.receiver.CastReceiverManager.SenderConnectedEvent} e
 */
function onSenderConnected(e) {
    var senders = castReceiverManager.getSenders();
    logger.info(LOG_PREFIX, 'Connected Senders:', senders, e);
}
/**
...
function onSenderDisconnected(e) {
    ...
    if (
        senders.length === 0 &&
        e.reason === cast.receiver.system.DisconnectReason.REQUESTED_BY_SENDER
    ) {
