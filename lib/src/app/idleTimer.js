...
const timeout = {
  PAUSED: 1000 * 60 * 5, // eslint-disable-line no-magic-numbers
  IDLE: 1000 * 60 * 10, // eslint-disable-line no-magic-numbers
};
 ...
 * given time
 *
 * @param {number} time The time after which castManager should get idle
 */
